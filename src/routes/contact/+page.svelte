...
<section class="flex justify-center items-center md:m-12">

    <div class="mt-4 lg:w-1/2 ">
      <div class="w-full px-8 border-2  bg-zinc-300 py-10 mx-auto overflow-hidden bg-texttext-text shadow-2xl rounded-xl dark:bg-gray-900">
        <h1 class="text-2xl font-medium text-gray-600light dark:text-gray-200">Get in touch with us</h1>
        ...
        <form class="mt-4">
          ...
          <div class="w-full mt-6">
            ...
            <textarea
              class="block w-full h-32 px-5 mt-2 text-borderColor placeholder-gray-400 bg-texttext-text border border-gray-200 rounded-md md:h-48 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-bgc focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring"
              placeholder="Message"
            />
          </div>

          <div class="flex justify-center items-center mt-10">
            <Button href="/media" variant={Variant.outline}>Submit</Button>
            </div>
        </form>
      </div>
    </div>
