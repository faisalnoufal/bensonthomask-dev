<section class="mb-14">
	...
	<div class="container px-6 py-10 mx-auto">
		<h1 class="text-2xl font-semibold text-center text-borderColor capitalize lg:text-3xl">
			<!-- class="text-2xl font-semibold text-center text-gray-800 capitalize lg:text-3xl dark:text-white" -->
			What our <span class="text-bgc">clients</span> say
		</h1>
		...
		<div class="grid grid-cols-1 gap-8 mx-auto mt-8 lg:grid-cols-2 xl:mt-10 max-w-7xl">
			<div class="p-6 bg-gray-100 rounded-lg md:p-8">
				...
				<p class="leading-loose text-gray-500">
					...
					ad tempora doloribus expedita laborum saepe voluptas perferendis delectus assumenda rerum,
				...
				<div class="flex items-center mt-6">
					...
					<div class="mx-4">
						<h1 class="font-semibold text-borderColor">Robbert</h1>
			...
			<div class="p-6 bg-gray-100 rounded-lg md:p-8">
				...
				<div class="flex items-center mt-6">
					...
					<div class="mx-4">
						<h1 class="font-semibold text-borderColor">Mia Brown</h1>
